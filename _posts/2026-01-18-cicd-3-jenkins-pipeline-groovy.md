---
layout: post
title: "[Part 3] Jenkins Pipeline 기초 - Groovy와 Pipeline 문법"
...
> - **Part 3: Jenkins Pipeline + Groovy 기초** (현재 글)
...
9. [디버깅 팁](#9-디버깅-팁)
10. [실전 분석: app-builder-plugin의 build.groovy](#10-실전-분석-app-builder-plugin의-buildgroovy)
11. [참고 자료](#11-참고-자료)
...
| `def call(...)`     | **vars/** 폴더의 파일명이 함수명이 됨. `build.groovy` → `build()` |
...
> **주의**: BuildKit의 병렬 실행은 **모듈 간 병렬이 아닙니다!**
> 모듈은 순차 실행되고, **하나의 Dockerfile 내부 스테이지**가 병렬로 실행됩니다.
